    ...
    execute: function () {
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(_crd && NetworkManager === void 0 ? (_reportPossibleCrUseOfNetworkManager({
        ...
        async onAddCoinBtnClick() {
          // 调用我们写的网络方法
          const newCoinValue = await this.networkManager.addCoin(this.myUserId); // 只有当服务器返回成功后，前端才更新显示
...
//# sourceMappingURL=8aa96fa3c4df08a5978d7c3dc9715e7f863a710e.js.map